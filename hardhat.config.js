...
console.log(process.env.POLYGON_TESTNET_PRIVATE_KEY);
...
module.exports = {
  ...
  networks: {
    ...
    //Polygon Testnet
    matic: {
      url: "https://polygon-amoy.infura.io/v3/4458cf4d1689497b9a38b1d6bbf05e78",
      chainId: 80002,
    ...
    development: {
      ...
      gasPrice:20000000000,
      accounts: [`0x33ca9638dd5862ce1960cfc4affa628ebfe3d29e5ca0180d79e19390ad0fdf9f`] 
    },
  },
